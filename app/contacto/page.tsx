      ...
      <main className="contact-section">
        <div className="contact-header">
          ...
          <h1 className="contact-title">
            HABLEMOS DE TU
            <br />
            <span className="highlight">PROYECTO</span>
          </h1>
          <p className="contact-subtitle">
            Estoy disponible para proyectos freelance, colaboraciones o simplemente para charlar sobre tecnologia.
          </p>
        </div>
        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-info-item hover-lift">
              ...
              <p className="contact-info-text">
                <a href="mailto:drcv.work.code@gmail.com">drcv.work.code@gmail.com</a>
              </p>
            </div>
